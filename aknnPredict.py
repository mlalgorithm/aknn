...
def main():
    ...
    parser.add_argument('--result', type=str, default='Result', metavar='R', help='filename to keep the result of screening, index of screened samples are kept. the default is ScreenResult.txt (optional)')
    ...
    print('Results is saved in %s.'%(args.result))
