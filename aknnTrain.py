    ...
    for k in np.arange(2,itermax):
        ...
        if smaxk<loss*0.95:
            ...
            if k==itermax-1:
                ...
                print('subset= ',str(subset))
                print('Training finished.Results is saved in %s.\n\nResult:'%(outfile))
...
def main():
    ...
    parser.add_argument('--out', type=str, default='model', metavar='O', help='filename to keep the output of training. the default is lbsmodel.npz (optional)')
